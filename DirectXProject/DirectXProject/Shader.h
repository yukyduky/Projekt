...
public:
	...
	bool CreateTessShaders(ID3D11Device* gDevice, const wchar_t* fileNameHull, const wchar_t* fileNameDomain);
	void Release();
...
private:
	...
	ID3D11HullShader* gHullShader;
	ID3D11DomainShader* gDomainShader;
